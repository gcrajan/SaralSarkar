...
<?php $Department = new Department($Database_connection,2) ?>
    ...
    <section id="profile-section">
        ...
        <div id="div-profile-section">
            ...
            <div id="detail-div-profile-section">
                <p>नाम: <span id="detail-info-div-profile-section">तुलसीपुर विद्युत प्राधिकरण</span></p>
                <p>सम्पर्क: <span id="detail-info-div-profile-section">९८0000२00४</span></p>
                <p>इमेल: <span id="detail-info-div-profile-section">bidhuthpradhikaran@gmail.com</span></p>
