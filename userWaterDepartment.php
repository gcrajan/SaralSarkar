...
<?php $Department = new Department($Database_connection,3) ?>
...
<?php require("Component/navigation.php") ?>
    ...
    <section id="profile-section">
        ...
        <div id="div-profile-section">
            <img src="./images/watersupply.jpg">
            <div id="detail-div-profile-section">
                <p>नाम: <span id="detail-info-div-profile-section">तुलसीपुर खानेपानी विभाग</span></p>
